...
namespace minitoolbox
{
    ...
    public class ConfigurationItem2 : SingletonOptions<ConfigurationItem2>
    {
        ...
        [Option("minitoolbox.建筑2.电池舱.漏电", "", null, Format = "F0")]
        [JsonProperty]
        ...
        //________________________________________________________________________________________
        [Option("minitoolbox.建筑2.功率转变器.发热", "", "minitoolbox.STRINGS2.建筑自热配置", Format = "F0")]
        [JsonProperty]
        ...
        //________________________________________________________________________________________
        [Option("minitoolbox.建筑2.电池舱.容量", "", "minitoolbox.STRINGS2.容量配置", Format = "F1")]
        [Limit(100, 500000.0)]
        [JsonProperty]
