    ...
    public class STRINGS
    {
        ...
        public static class 其它
        {
            ...
            public static class 超级气压服
            {
                ...
                public static LocString 细节 = "Mining changed to 100, insulation heat changed to 3000, temperature damage area changed to 6000, speed changed to 100, insulation thickness changed to 10";
            }
            public static class 挖掘掉落
            {
                public static LocString 描述 = "The multiple of fragments produced by mining";
            }
            public static class 物品堆叠
            {
                public static LocString 描述 = "The maximum stack size of the item";
                public static LocString 细节 = "In the game, when the stacking amount of debris reaches 25 tons, it will change to another column until the next time it reaches 25 tons";
            }
