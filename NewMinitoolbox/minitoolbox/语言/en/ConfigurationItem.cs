...
namespace minitoolbox
{
    ...
    public class ConfigurationItem : SingletonOptions<ConfigurationItem>
    {
        ...
        [Option("STRINGS.其它.睡觉.描述", "", null)]
        [JsonProperty]
        public bool NoWantSleepPatch { get; set; }

        [Option("STRINGS.建筑.电池舱.漏电", "", null, Format = "F0")]
        [JsonProperty]
        public bool 电池舱 { get; set; }

        [Option("STRINGS.其它.超级气压服.描述", "STRINGS.其它.超级气压服.细节", null, Format = "F0")]
        [JsonProperty]
        public bool super_atmosuit { get; set; }

        [Option("STRINGS.其它.物品堆叠.描述", "STRINGS.其它.物品堆叠.细节", null, Format = "F0")]
        //
        [Limit(25, 100)]
        [JsonProperty]
        public float stack { get; set; }

        [Option("STRINGS.其它.挖掘掉落.描述", "", null, Format = "F1")]
        //区间是0.5到5倍，0.5是缺氧默认的
        [Limit(0.5, 5)]
        [JsonProperty]
        public float HightDiggingRatio_Magnification { get; set; }

        [Option("STRINGS.其它.擦水.描述", "", null, Format = "F0")]
        [JsonProperty]
        public bool Mop_Max { get; set; }
        //________________________________________________________________________________________
        [Option("STRINGS.建筑.冰箱.容量", "", "", Format = "F0")]
        [Limit(100.0, 1000000.0)]
        [JsonProperty]
        public float Refrigerator_Capacity { get; set; }

        [Option("STRINGS.建筑.冰箱.功率", "", "STRINGS.Config.功率配置", Format = "F0")]
        [Limit(1,120)]
        [JsonProperty]
        public float Refrigerator_Electricity { get; set; }

        [Option("STRINGS.建筑.冰箱.淹没", "", "STRINGS.Config.建筑淹没配置", Format = "F0")]
        [JsonProperty]
        public bool Refrigerator_Submerge { get; set; }

        [Option("STRINGS.建筑.冰箱.过热", "", "STRINGS.Config.建筑过热配置", Format = "F0")]
        [JsonProperty]
        public bool Refrigerator_Overheat { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.建筑.储物箱.容量", "", "STRINGS.Config.容量配置", Format = "F0")]
        [Limit(20000.0, 10000000.0)]
        [JsonProperty]
        public float StorageBox_Capacity { get; set; }

        //[Option("STRINGS.建筑.储物箱.过热", "", "STRINGS.Config.建筑过热配置", Format = "F0")]
        //[JsonProperty]
        //public bool StorageBox_Overheat { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.建筑.气库.容量", "", "STRINGS.Config.容量配置", Format = "F0")]
        [Limit(150, 100000.0)]
        [JsonProperty]
        public float GasReservoir_Capacity { get; set; }

        [Option("STRINGS.建筑.气库.地基", "", null, Format = "F0")]
        [JsonProperty]
        public bool GasReservoir_foundation { get; set; }

        [Option("STRINGS.建筑.气库.过热", "", "STRINGS.Config.建筑过热配置", Format = "F0")]
        [JsonProperty]
        public bool GasReservoir_Overheat { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.建筑.液库.容量", "", "STRINGS.Config.容量配置", Format = "F0")]
        [Limit(5000, 100000.0)]
        [JsonProperty]
        public float LiquidReservoir_Capacity { get; set; }

        [Option("STRINGS.建筑.液库.地基", "", null, Format = "F0")]
        [JsonProperty]
        public bool LiquidReservoir_foundation { get; set; }

        [Option("STRINGS.建筑.液库.过热", "", "STRINGS.Config.建筑过热配置", Format = "F0")]
        [JsonProperty]
        public bool LiquidReservoir_Overheat { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.建筑.线路.电线", "", "STRINGS.Config.电力配置", Format = "F0")]
        [Limit(1, 1000.0)]
        [JsonProperty]
        public float ElectricWire_Thinline { get; set; }

        [Option("STRINGS.建筑.线路.导线", "", "STRINGS.Config.电力配置", Format = "F0")]
        [Limit(2, 1000.0)]
        [JsonProperty]
        public float ElectricWire_wire { get; set; }

        [Option("STRINGS.建筑.线路.高负荷电线", "", "STRINGS.Config.电力配置", Format = "F0")]
        [Limit(20, 1000.0)]
        [JsonProperty]
        public float ElectricWire_Thickline { get; set; }

        [Option("STRINGS.建筑.线路.高负荷导线", " ", "STRINGS.Config.电力配置", Format = "F0")]
        [Limit(50, 1000.0)]
        [JsonProperty]
        public float ElectricWire_HighVoltageline { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.建筑.金属精炼器.容量", " ", "STRINGS.Config.容量配置", Format = "F0")]
        [Limit(800, 4000)]
        [JsonProperty]
        public float MetalRefinery_Capacity { get; set; }
        
        [Option("STRINGS.建筑.金属精炼器.功率", "", "STRINGS.Config.功率配置", Format = "F0")]
        [Limit(1, 1200)]
        [JsonProperty]
        public float MetalRefinery_Electricity { get; set; }

        [Option("STRINGS.建筑.金属精炼器.加热冷却剂", "", null, Format = "F0")]
        [JsonProperty]
        public bool MetalRefinery_Heating { get; set; }

        [Option("STRINGS.建筑.金属精炼器.发热", "", "STRINGS.Config.建筑自热配置")]
        [JsonProperty]
        public bool MetalRefinery_SelfHeating { get; set; }

        [Option("STRINGS.建筑.金属精炼器.淹没", "", "STRINGS.Config.建筑淹没配置", Format = "F0")]
        [JsonProperty]
        public bool MetalRefinery_Submerge { get; set; }

        [Option("STRINGS.建筑.金属精炼器.过热", "", "STRINGS.Config.建筑过热配置", Format = "F0")]
        [JsonProperty]
        public bool MetalRefinery_Overheat { get; set; }
       
        [Option("STRINGS.建筑.金属精炼器.操作", "", "STRINGS.Config.人力操作", Format = "F0")]
        [JsonProperty]
        public bool MetalRefinery_automatic { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.建筑.电解器.功率", "", "STRINGS.Config.功率配置", Format = "F0")]
        [Limit(1, 120)]
        [JsonProperty]
        public float Electrolyzer_Electricity { get; set; }

        [Option("STRINGS.建筑.电解器.排出的氢气量", "", "STRINGS.Config.排气配置",Format = "F2")]
        [Limit(0, 5000.0)]
        [JsonProperty]
        public float HydrogenVolume { get; set; }

        [Option("STRINGS.建筑.电解器.排出的氧气量", "", "STRINGS.Config.排气配置", Format = "F2")]
        [Limit(0, 5000.0)]
        [JsonProperty]
        public float OxygenVolume { get; set; }

        [Option("STRINGS.建筑.电解器.发热", "", "STRINGS.Config.建筑自热配置", Format = "F0")]
        [JsonProperty]
        public bool Electrolyzer_SelfHeating { get; set; }

        [Option("STRINGS.建筑.电解器.过热", "", "STRINGS.Config.建筑过热配置", Format = "F0")]
        [JsonProperty]
        public bool Electrolyzer_Overheat { get; set; }
        
        [Option("STRINGS.建筑.电解器.淹没", "", "STRINGS.Config.建筑淹没配置", Format = "F0")]
        [JsonProperty]
        public bool Electrolyzer_Submerge { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.建筑.火箭.钻头前锥钻石容量", "", "STRINGS.Config.容量配置", Format="F0")]
        [Limit(1000, 2700.0)]
        [JsonProperty]
        public float NoseconeHarvest_Capacity { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.建筑.人力发电机.发电量", "", "STRINGS.Config.电力配置", Format = "F0")]
        [Limit(400, 4000)]
        [JsonProperty]
        public float ManualGeneratorr_GenerateElectricity { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.建筑.木料燃烧器.发电量", "", "STRINGS.Config.电力配置", Format = "F0")]
        [Limit(400, 4000)]
        [JsonProperty]
        public float WoodGasGenerator_GenerateElectricity { get; set; }

        [Option("STRINGS.建筑.木料燃烧器.二氧化碳排放量", "", "STRINGS.Config.排气配置")]
        [Limit(0, 10000)]
        [JsonProperty]
        public float WoodGasGenerator_CarbonDioxideVolume { get; set; }

        [Option("STRINGS.建筑.木料燃烧器.发热", "", "STRINGS.Config.建筑自热配置", Format = "F0")]
        [JsonProperty]
        public bool WoodGasGenerator_SelfHeating { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.建筑.煤炭发电机.发电量", "", "STRINGS.Config.电力配置", Format = "F0")]
        [Limit(600, 6000)]
        [JsonProperty]
        public float Generator_GenerateElectricity { get; set; }

        [Option("STRINGS.建筑.煤炭发电机.二氧化碳排放量", "", "STRINGS.Config.排气配置")]
        [Limit(0, 10000)]
        [JsonProperty]
        public float Generator_CarbonDioxideVolume { get; set; }

        [Option("STRINGS.建筑.煤炭发电机.发热", "", "STRINGS.Config.建筑自热配置", Format = "F0")]
        [JsonProperty]
        public bool Generator_SelfHeating { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.建筑.氢气发电机.发电量", "", "STRINGS.Config.电力配置", Format = "F0")]
        [Limit(800, 8000)]
        [JsonProperty]
        public float HydrogenGenerator_GenerateElectricity { get; set; }

        [Option("STRINGS.建筑.氢气发电机.发热", "", "STRINGS.Config.建筑自热配置", Format = "F0")]
        [JsonProperty]
        public bool HydrogenGenerator_SelfHeating { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.建筑.太阳能.发电量", "", "STRINGS.Config.电力配置", Format = "F0")]
        [Limit(380, 3780.0)]
        [JsonProperty]
        public float Maximum_solar_power_generation { get; set; }

        [Option("STRINGS.建筑.太阳能.勒克斯", "", "STRINGS.Config.电力配置", Format = "F5")]
        [Limit(0.00053, 0.01)]
        [JsonProperty]
        public float Power_per_lux_of_solar_energy { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.建筑.功率转变器.发热", "", "STRINGS.Config.建筑自热配置", Format = "F0")]
        [JsonProperty]
        public bool PowerTransformer_SelfHeating { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.建筑.原油精炼器.功率", "", "STRINGS.Config.功率配置", Format = "F0")]
        [Limit(1, 480)]
        [JsonProperty]
        public float OilRefinery_Electricity { get; set; }

        [Option("STRINGS.建筑.原油精炼器.天然气量", "", "STRINGS.Config.排气配置")]
        [Limit(0, 5000.0)]
        [JsonProperty]
        public float MethaneVolume { get; set; }

        [Option("STRINGS.建筑.原油精炼器.石油量", "", "STRINGS.Config.排液配置")]
        [Limit(0, 5000.0)]
        [JsonProperty]
        public float PetroleumVolume { get; set; }

        [Option("STRINGS.建筑.原油精炼器.发热", "", "STRINGS.Config.建筑自热配置", Format = "F0")]
        [JsonProperty]
        public bool OilRefinery_SelfHeating { get; set; }

        [Option("STRINGS.建筑.原油精炼器.过热", "", "STRINGS.Config.建筑过热配置", Format = "F0")]
        [JsonProperty]
        public bool OilRefinery_Overheat { get; set; }

        [Option("STRINGS.建筑.原油精炼器.淹没", "", "STRINGS.Config.建筑淹没配置", Format = "F0")]
        [JsonProperty]
        public bool OilRefinery_Submerge { get; set; }
        
        [Option("STRINGS.建筑.原油精炼器.操作", "", "STRINGS.Config.人力操作", Format = "F0")]
        [JsonProperty]
        public bool OilRefinery_automatic { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.其它.植物.水草", "", "STRINGS.Config.植物生长时间", Format = "F0")]
        [Limit(10, 7200.0)]
        [JsonProperty]
        public float Lettuce_Growth_Time { get; set; }

        [Option("STRINGS.其它.植物.虫果", "", "STRINGS.Config.植物生长时间", Format = "F0")]
        [Limit(10, 4800.0)]
        [JsonProperty]
        public float WormSuperFruit_Growth_Time { get; set; }

        [Option("STRINGS.其它.植物.米虱木", "", "STRINGS.Config.植物生长时间", Format = "F0")]
        [Limit(10, 1800.0)]
        [JsonProperty]
        public float BasicPlantFood_Growth_Time { get; set; }

        [Option("STRINGS.其它.植物.毛刺花", "", "STRINGS.Config.植物生长时间", Format = "F0")]
        [Limit(10, 3600.0)]
        [JsonProperty]
        public float PrickleFruit_Growth_Time { get; set; }

        [Option("STRINGS.其它.植物.夜幕菇", "", "STRINGS.Config.植物生长时间", Format = "F0")]
        [Limit(10, 4500.0)]
        [JsonProperty]
        public float Mushroom_Growth_Time { get; set; }

        [Option("STRINGS.其它.植物.火椒藤", "", "STRINGS.Config.植物生长时间", Format = "F0")]
        [Limit(10, 4800.0)]
        [JsonProperty]
        public float SpiceNut_Growth_Time { get; set; }

        [Option("STRINGS.其它.植物.释气草", "", "STRINGS.Config.植物生长时间", Format = "F0")]
        [Limit(10, 2400.0)]
        [JsonProperty]
        public float GasGrassHarvested_Growth_Time { get; set; }

        [Option("STRINGS.其它.植物.乔木树", "", "STRINGS.Config.植物生长时间", Format = "F0")]
        [Limit(10, 2700.0)]
        [JsonProperty]
        public float WoodLog_Growth_Time { get; set; }

        [Option("STRINGS.其它.植物.小吃芽", "", "STRINGS.Config.植物生长时间", Format = "F0")]
        [Limit(10, 12600.0)]
        [JsonProperty]
        public float BeanPlantSeed_Growth_Time { get; set; }

        [Option("STRINGS.其它.植物.沙盐藤", "", "STRINGS.Config.植物生长时间", Format = "F0")]
        [Limit(10, 3600.0)]
        [JsonProperty]
        public float Salt_Growth_Time { get; set; }

        [Option("STRINGS.其它.植物.仙水掌", "", "STRINGS.Config.植物生长时间", Format = "F0")]
        [Limit(10, 6000.0)]
        [JsonProperty]
        public float Water_Growth_Time { get; set; }

        [Option("STRINGS.其它.植物.沼浆笼", "", "STRINGS.Config.植物生长时间", Format = "F0")]
        [Limit(10, 3960.0)]
        [JsonProperty]
        public float SwampFruit_Growth_Time { get; set; }

        [Option("STRINGS.其它.植物.顶针芦苇", "", "STRINGS.Config.植物生长时间", Format = "F0")]
        [Limit(10, 1200.0)]
        [JsonProperty]
        public float BasicFabric_Growth_Time { get; set; }

        [Option("STRINGS.其它.植物.冰霜小麦", "", "STRINGS.Config.植物生长时间", Format = "F0")]
        [Limit(10, 10800.0)]
        [JsonProperty]
        public float ColdWheatSeed_Growth_Time { get; set; }

        [Option("STRINGS.其它.植物.芳香百合", "", "STRINGS.Config.植物生长时间", Format = "F0")]
        [Limit(10, 7200.0)]
        [JsonProperty]
        public float SwampLilyFlower_Growth_Time { get; set; }

        [Option("STRINGS.其它.植物.贫瘠虫果", "", "STRINGS.Config.植物生长时间", Format = "F0")]
        [Limit(10, 2400.0)]
        [JsonProperty]
        public float WormBasicFruit_Growth_Time { get; set; }

        [Option("STRINGS.其它.植物.土星动物捕草", "", "STRINGS.Config.植物生长时间", Format = "F0")]
        [Limit(10, 18000.0)]
        [JsonProperty]
        public float PlantMeat_Growth_Time { get; set; }


        [Option("STRINGS.其它.植物.水草", "", "STRINGS.Config.植物收获数量")]
        [JsonProperty]
        public int Lettuce_Harvest_Quantity { get; set; }

        [Option("STRINGS.其它.植物.虫果", "", "STRINGS.Config.植物收获数量")]
        [JsonProperty]
        public int WormSuperFruit_Harvest_Quantity { get; set; }

        [Option("STRINGS.其它.植物.米虱木", "", "STRINGS.Config.植物收获数量")]
        [JsonProperty]
        public int BasicPlantFood_Harvest_Quantity { get; set; }

        [Option("STRINGS.其它.植物.毛刺花", "", "STRINGS.Config.植物收获数量")]
        [JsonProperty]
        public int PrickleFruit_Harvest_Quantity { get; set; }

        [Option("STRINGS.其它.植物.夜幕菇", "", "STRINGS.Config.植物收获数量")]
        [JsonProperty]
        public int Mushroom_Harvest_Quantity { get; set; }

        [Option("STRINGS.其它.植物.火椒藤", "", "STRINGS.Config.植物收获数量")]
        [JsonProperty]
        public int SpiceNut_Harvest_Quantity { get; set; }

        [Option("STRINGS.其它.植物.释气草", "", "STRINGS.Config.植物收获数量")]
        [JsonProperty]
        public int GasGrassHarvested_Harvest_Quantity { get; set; }

        [Option("STRINGS.其它.植物.乔木树", "", "STRINGS.Config.植物收获数量")]
        [JsonProperty]
        public int WoodLog_Harvest_Quantity { get; set; }

        [Option("STRINGS.其它.植物.小吃芽", "", "STRINGS.Config.植物收获数量")]
        [JsonProperty]
        public int BeanPlantSeed_Harvest_Quantity { get; set; }

        [Option("STRINGS.其它.植物.沙盐藤", "", "STRINGS.Config.植物收获数量")]
        [JsonProperty]
        public int Salt_Harvest_Quantity { get; set; }

        [Option("STRINGS.其它.植物.仙水掌", "", "STRINGS.Config.植物收获数量")]
        [JsonProperty]
        public int Water_Harvest_Quantity { get; set; }

        [Option("STRINGS.其它.植物.沼浆笼", "", "STRINGS.Config.植物收获数量")]
        [JsonProperty]
        public int SwampFruit_Harvest_Quantity { get; set; }

        [Option("STRINGS.其它.植物.冰霜小麦", "", "STRINGS.Config.植物收获数量")]
        [JsonProperty]
        public int ColdWheatSeed_Harvest_Quantity { get; set; }

        [Option("STRINGS.其它.植物.顶针芦苇", "", "STRINGS.Config.植物收获数量")]
        [JsonProperty]
        public int BasicFabric_Harvest_Quantity { get; set; }

        [Option("STRINGS.其它.植物.芳香百合", "", "STRINGS.Config.植物收获数量")]
        [JsonProperty]
        public int SwampLilyFlower_Harvest_Quantity { get; set; }

        [Option("STRINGS.其它.植物.贫瘠虫果", "", "STRINGS.Config.植物收获数量")]
        [JsonProperty]
        public int WormBasicFruit_Harvest_Quantity { get; set; }

        [Option("STRINGS.其它.植物.土星动物捕草", "", "STRINGS.Config.植物收获数量")]
        [JsonProperty]
        public int PlantMeat_Harvest_Quantity { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.建筑.液泵.功率", "", "STRINGS.Config.功率配置", Format = "F0")]
        [Limit(1, 240)]
        [JsonProperty]
        public float LiquidPump_Electricity { get; set; }

        [Option("STRINGS.建筑.液泵.发热", "", "STRINGS.Config.建筑自热配置", Format = "F0")]
        [JsonProperty]
        public bool LiquidPump_SelfHeating { get; set; }

        [Option("STRINGS.建筑.液泵.过热", "", "STRINGS.Config.建筑过热配置", Format = "F0")]
        [JsonProperty]
        public bool LiquidPump_Overheat { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.建筑.液体过滤器.功率", "", "STRINGS.Config.功率配置", Format = "F0")]
        [Limit(1, 120)]
        [JsonProperty]
        public float LiquidFilter_Electricity { get; set; }

        [Option("STRINGS.建筑.液体过滤器.发热", "", "STRINGS.Config.建筑自热配置", Format = "F0")]
        [JsonProperty]
        public bool LiquidFilter_SelfHeating { get; set; }

        [Option("STRINGS.建筑.液体过滤器.过热", "", "STRINGS.Config.建筑过热配置", Format = "F0")]
        [JsonProperty]
        public bool LiquidFilter_Overheat { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.建筑.气体过滤器.功率", "", "STRINGS.Config.功率配置", Format = "F0")]
        [Limit(1, 120)]
        [JsonProperty]
        public float GasFilter_Electricity { get; set; }

        [Option("STRINGS.建筑.气体过滤器.过热", "", "STRINGS.Config.建筑过热配置", Format = "F0")]
        [JsonProperty]
        public bool GasFilter_Overheat { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.建筑.自动清扫器.功率", "", "STRINGS.Config.功率配置", Format = "F0")]
        [Limit(1, 120)]
        [JsonProperty]
        public float SolidTransferArm_Electricity { get; set; }

        [Option("STRINGS.建筑.自动清扫器.发热", "", "STRINGS.Config.建筑自热配置", Format = "F0")]
        [JsonProperty]
        public bool SolidTransferArm_SelfHeating { get; set; }

        [Option("STRINGS.建筑.自动清扫器.过热", "", "STRINGS.Config.建筑过热配置", Format = "F0")]
        [JsonProperty]
        public bool SolidTransferArm_Overheat { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.建筑.运输轨道.容量", "", "STRINGS.Config.运输配置", Format = "F0")]
        [Limit(20, 1000.0)]
        [JsonProperty]
        public float Transport_Track_Capacity { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.建筑.运输存放器.容量", "", "STRINGS.Config.容量配置", Format = "F0")]
        [Limit(100, 100000.0)]
        [JsonProperty]
        public float SolidConduitOutbox_Capacity { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.建筑.运输装载器.发热", "", "STRINGS.Config.建筑自热配置", Format = "F0")]
        [JsonProperty]
        public bool SolidConduitInbox_SelfHeating { get; set; }

        [Option("STRINGS.建筑.运输装载器.过热", "", "STRINGS.Config.建筑过热配置", Format = "F0")]
        [JsonProperty]
        public bool SolidConduitInbox_Overheat { get; set; }

        [Option("STRINGS.建筑.运输装载器.容量", "", "STRINGS.Config.容量配置", Format = "F0")]
        [Limit(1000, 100000)]
        [JsonProperty]
        public float SolidConduitInbox_Capacity { get; set; }

        [Option("STRINGS.建筑.运输装载器.功率", "", "STRINGS.Config.功率配置", Format = "F0")]
        [Limit(1, 120)]
        [JsonProperty]
        public float SolidConduitInbox_Electricity { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.建筑.氧气扩散器.功率", "", "STRINGS.Config.功率配置", Format = "F0")]
        [Limit(1, 120)]
        [JsonProperty]
        public float MineralDeoxidizer_Electricity { get; set; }

        [Option("STRINGS.建筑.氧气扩散器.淹没", "", "STRINGS.Config.建筑淹没配置")]
        [JsonProperty]
        public bool MineralDeoxidizer_Submerge { get; set; }

        [Option("STRINGS.建筑.氧气扩散器.过热", "", "STRINGS.Config.建筑过热配置")]
        [JsonProperty]
        public bool MineralDeoxidizer_Overheat { get; set; }

        [Option("STRINGS.建筑.氧气扩散器.发热", "", "STRINGS.Config.建筑自热配置")]
        [JsonProperty]
        public bool MineralDeoxidizer_SelfHeating { get; set; }

        [Option("STRINGS.建筑.氧气扩散器.排出的氧气量", "", "STRINGS.Config.排气配置",Format = "F1")]
        [Limit(0, 5000.0)]
        [JsonProperty]
        public float MineralDeoxidizer_OxygenVolume { get; set; }

        //________________________________________________________________________________________
        [Option("STRINGS.建筑.电池舱.容量", "", "STRINGS.Config.容量配置", Format = "F1")]
        [Limit(100, 500000.0)]
        [JsonProperty]
        ...
        {
            this.stack = 25; // 最大堆叠量/吨
            this.NoWantSleepPatch = false;  // 睡觉
            this.super_atmosuit = false;  //超级气压服
            this.电池舱 = false;
            this.电池舱容量 = 100f;
